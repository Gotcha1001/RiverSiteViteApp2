    ...
    return (
        <div className="container py-4">
            <div className="lg:flex lg:items-start lg:justify-between mb-8">
                {/* Left Column */}
                <div className="lg:w-1/2 lg:pr-4 mb-8 gradient-background2 p-4 rounded-lg neon-purple">
                    <h2 className="text-3xl font-bold mb-4 text-center lg:text-left text-white neon-sky rounded-md p-3">Giving</h2>
                    <p className="mb-4 text-white neon-purple p-2 rounded-md">
                ...
                {/* Right Column */}
                <div className="lg:w-1/2  gradient-background2 neon-purple p-6 rounded-lg  mt-8 lg:mt-0 lg:ml-8 lg:self-center ">
                    <p className="mb-4 hover:bg-black rounded-md p-4 text-white">
            ...
            <div className="text-center mt-16">
                <h2 className="text-3xl font-bold mb-4 bg-teal-500 rounded-md neon-blue zoom">OFFERING</h2>
                <div className="flex justify-center items-center mt-8 space-x-4">
                    <img src="/zapper1.jpg" alt="Image 1" className="w-1/2 max-w-sm rounded-md shadow-md" />

                </div>
                <p className="mb-4 neon-purple rounded-lg p-3 mt-4 gradient-background2 text-white">
                    This is an opportunity to give to God during the service. Offerings are taken up at our Sunday meetings, where you may utilize cash, Zapper and Yoco.
                </p>
                <p className="mb-4 font-bold ">EFT – ELECTRONIC FUNDS TRANSFER</p>
                <p className="mb-4 bg-slate-950 rounded-md text-white zoom neon-purple">
