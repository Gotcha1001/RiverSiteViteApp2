...
export default function Services() {
    return (
        <div className="min-h-screen p-3 flex flex-col justify-center items-center bg-gradient-to-b from-black to-gray-900 text-white">
            ...
            <div className="w-full max-w-md bg-slate-950 shadow-lg rounded-lg p-6 transition-transform transform hover:scale-105">
                <div className="group mb-6">
                    <h4 className="text-3xl font-bold mb-2 text-center">
                        <span className="text-grey-300">Sundays : 9am</span>
                    </h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div className="bg-slate-700 p-4 rounded-lg text-center hover:shadow-xl transform hover:scale-105 relative">
                ...
                <div className="bg-slate-700 p-4 rounded-lg text-center hover:shadow-xl transform hover:scale-105">
