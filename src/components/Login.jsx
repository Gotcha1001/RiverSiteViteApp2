...
import { auth, signInWithEmailAndPassword, signInWithPopup, GoogleAuthProvider, signOut, onAuthStateChanged } from '../firebaseconfig/firebase'; // Ensure this is the correct path
